  ...
  return (
    <>
      ...
      <LazyLoadedText className="explantion">
        Os primeiros registros desta fórmula remonta à Babilônia antiga e foi
        aprimorada ao longo da história por diversos matemáticos e economistas.
      </LazyLoadedText>
      <LazyLoadedText>
        Uma das primeiras referências documentadas a uma fórmula de juros
        compostos de forma explícita foi na obra <i>Summa de Arithmetica</i> do
        matemático italiano Luca Pacioli.
      </LazyLoadedText>
      <LazyLoadedText>
