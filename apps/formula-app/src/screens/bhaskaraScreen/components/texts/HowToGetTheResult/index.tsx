...
function HowToGetTheResult({ a, b, c }: HowToGetTheResultProps): JSX.Element {
  ...
  return (
    <>
      ...
      <ol type="1">
        <li>
          Primeiro precisamos calcular o descriminante (delta) como base nos
          coeficientes fornecidos (a, b e c):
        ...
        {delta !== undefined ? (
          <>
            ...
            {delta < 0 ? (
              <li>
                Já que temos o valor menor que zero, não será necessário
                prosseguir com o calculo
              </li>
            ) : (
