    ...
    <>
      ...
      <ol type="1">
        {values ? (
          <>
            <li>
              Primeiro verificamos quantos números temos somando, neste caso
              temos <strong>{values.length}</strong> números.
            </li>
            <li>
              Agora realizamos a soma de todos os números. Com isso, obtemos o
              resultado <strong>{soma}</strong>
            </li>
            <li>
              Por fim, basta dividir este resultado ({soma}) por{" "}
              <strong>{values.length}</strong> e, assim, o teremos como
